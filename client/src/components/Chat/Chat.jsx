...
const Chat = () => {
  ...
  return (
    ...
    >
            ...
            >
              ...
              {isSettingOpen && (
                <div className="setting-wrapper">
                  ...
                  >
                    <div className="setting-item">Log out</div>
                  </NavLink>
                  <div
                    className="setting-item"
                    onClick={() =>
                      setIsOpenChangeProfileForm(!isOpenChangeProfileForm)
                    }
                  >
                    change profile
                  </div>
      ...
      {isOpenChangeProfileForm && (
        <ChangeProfileForm
          open={isOpenChangeProfileForm}
          handleClose={() => setIsOpenChangeProfileForm(false)}
          userCurrent={userCurrent}
        />
      )}
      {isOpenChangePasswordForm && (
        <ChangePasswordForm
          open={isOpenChangePasswordForm}
          handleClose={() => setIsOpenChangePasswordForm(false)}
        />
      )}
      {shouldOpenUserInfoDialog ? (
        <div className="col-3">
